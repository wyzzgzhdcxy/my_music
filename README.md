...
一款简洁优雅的本地音乐播放器，基于 [Wails](https://wails.io/)（Go + Vue.js）开发的桌面应用。
...
- 支持 MP4、MKV、AVI、MOV、WMV、WebM 等视频格式
- 本地 HTTP 音频流服务，高效稳定
...
- 本地未找到时，自动从 [LRCLIB](https://lrclib.net/) 和网易云音乐在线下载
- 支持逐行高亮显示，跟随播放进度滚动
